          ...
          child: Column(
            ...
            children: [
              ...
              TweenAnimationBuilder<int>(
                duration: const Duration(milliseconds: 2000),
                tween: IntTween(begin: 0, end: "Welcome to Kisan Krushi".length),
                builder: (context, value, child) {
                  return Text(
                    "Welcome to Kisan Krushi".substring(0, value),
                    style: const TextStyle(
                      fontSize: 32,
                      fontWeight: FontWeight.bold,
                      color: Colors.white,
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                'Your data is safely stored in the cloud with Google Drive integration. Access your information anytime, anywhere.',
                style: TextStyle(
                  fontSize: 16,
                  color: Colors.white70,
                  height: 1.5,
